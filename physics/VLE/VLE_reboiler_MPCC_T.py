...
from physics.bounds import VLE_bounds3 as VLE_bounds
...
def VLE_block_rule(block):
    ...
    # pseudo temperature Value
    block.T_VLE = pe.Var(within=pe.NonNegativeReals,bounds=(170,700+273.15)) # K
    ...
    def temperature_equal_rule(block):
        return block.T_VLE == block.parent_block().T
